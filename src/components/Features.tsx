...
const features = [
  {
    icon: (
      ...
      <svg className="w-10 h-10 text-[#B8962E]" viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="1">
        <circle cx="16" cy="20" r="10" />
        <circle cx="24" cy="20" r="10" />
        <path d="M16 10 A 10 10 0 0 1 16 30" stroke="currentColor" strokeWidth="1" strokeDasharray="2 2" opacity="0.5"/>
      </svg>
    ),
    title: "Connexion Émotionnelle",
    description: "Plongez dans les profondeurs de vos âmes. Découvrez comment vos sensibilités s'accordent et comment cultiver une intimité inébranlable.",
  },
  {
    icon: (
    ...
    description: "Vos cartes astrales entrelacées révèlent la fluidité de vos échanges. Déjouez les malentendus et élevez votre communication.",
  },
  {
    icon: (
      // Végétal délicat (croissance, nature)
      <svg className="w-10 h-10 text-[#B8962E]" viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="1.2">
        <path d="M20 36 V12" />
    ...
    description: "Explorez votre magnétisme naturel et laissez l'énergie de votre union vous élever mutuellement vers votre plein potentiel.",
  },
]

export function Features() {
  return (
    <section id="features" className="relative py-24 sm:py-36 bg-white overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20 sm:mb-28">
          ...
          >
            Trois dimensions <span className="text-[#B8962E] italic font-normal">sacrées</span> de votre couple
          </motion.h2>
          ...
          <motion.p
            ...
            style={{ fontFamily: "'Inter', Calibri, sans-serif", fontWeight: 400 }}
          >
            Une analyse profonde et nuancée, allant bien au-delà des horoscopes traditionnels, pour éclairer la véritable nature de votre lien.
          </motion.p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="relative group p-10 rounded-[24px] bg-white border border-[#B8962E]/10 hover:border-[#B8962E]/40 transition-all duration-500 overflow-hidden shadow-[0_15px_35px_rgba(26,92,82,0.05)] hover:shadow-[0_20px_40px_rgba(26,92,82,0.1)]"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-[21px] text-[#1A1A1A] font-semibold mb-4 tracking-wide leading-[1.3]" style={{ fontFamily: "'Montserrat', Arial, sans-serif" }}>
                  {feature.title}
                </h3>
                
                {/* Paragraphe de carte — Gris (#555555) — Inter Regular */}
                <p className="text-[15px] text-[#555555] leading-[1.65]" style={{ fontFamily: "'Inter', Calibri, sans-serif", fontWeight: 400 }}>
                  {feature.description}
                </p>
              </div>
            </motion.div>
