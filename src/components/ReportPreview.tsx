...
export function ReportPreview() {
  return (
    <section className="relative py-24 sm:py-36 bg-[#1A5C52] overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="relative w-full max-w-[400px] mx-auto group">
            ...
            <div className="absolute top-6 -left-4 right-4 h-full bg-white/20 backdrop-blur-md rounded-[16px] shadow-2xl border border-white/30 rotate-[-4deg] transition-transform duration-700 group-hover:rotate-[-6deg]" aria-hidden="true" />
            <div className="absolute top-3 -left-2 right-2 h-full bg-white/40 backdrop-blur-md rounded-[16px] shadow-2xl border border-white/40 rotate-[-2deg] transition-transform duration-700 group-hover:rotate-[-3deg]" aria-hidden="true" />
            ...
            <div className="relative bg-white/95 backdrop-blur-2xl rounded-[16px] shadow-[0_30px_60px_rgba(0,0,0,0.5)] border border-white p-10 sm:p-12 aspect-[1/1.41] flex flex-col z-10 overflow-hidden transition-transform duration-700 group-hover:translate-y-[-5px]">
              ...
              <div className="absolute top-0 right-0 w-40 h-40 opacity-[0.03] pointer-events-none">
                <svg viewBox="0 0 100 100" fill="none" stroke="#1A5C52" strokeWidth="0.5">
              ...
              <div className="flex items-center justify-center mb-8">
                <span className="font-bold text-2xl text-[#1A5C52]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Duovrai</span>
              </div>

              <h4 className="text-center text-[24px] mb-2 text-[#1A5C52]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Livre d'Harmonie</h4>
              <p className="text-center text-[11px] uppercase tracking-[0.3em] text-[#B8962E] mb-10 font-medium">Emma & Lucas</p>
              ...
              <div className="bg-gradient-to-br from-[#F9F3E3] to-white rounded-[12px] p-6 text-center mb-8 border border-[#B8962E]/20 shadow-[inset_0_2px_10px_rgba(184,150,46,0.05)]">
                <p className="text-[10px] uppercase tracking-widest text-[#1A5C52]/70 mb-2">Résonance Cosmique</p>
                <p
                ...
                <div className="w-full bg-[#1A5C52]/10 h-1.5 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-[#B8962E] to-[#d4b043] rounded-full relative" style={{ width: "92%" }}>
        ...
        >
          ...
          <h2 className="text-[40px] sm:text-[52px] leading-[1.1] text-white" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
            Un miroir d'une rare <span className="text-[#B8962E] italic">précision</span> sur votre couple.
          </h2>

          <p className="text-[16px] sm:text-[18px] leading-relaxed text-white/70 font-light max-w-xl">
            Imprégnez-vous d'une lecture intimiste. Notre intelligence artificielle, guidée par des principes astrologiques millénaires, compose un rapport de 12 pages qui se dévoile comme un livre écrit à la lueur d'une bougie, spécialement pour vous deux.
          </p>
          ...
          <ul className="space-y-6 mt-6 w-full">
            {[
              ...
              <li key={i} className="flex items-start gap-5 text-[17px] text-white/80 font-light">
