...
export default function PlanSection() {
  return (
    <section id="commander" className="py-20 sm:py-24 bg-[#F9F3E3]">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <motion.h2
            ...
            className="text-[28px] sm:text-[36px] mb-4"
          >
          ...
          >
            Deux offres pensées pour vous éclairer. Paiement unique, aucun
            abonnement caché.
          </motion.p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white shadow-xl rounded-[6px] border border-[#E8F2F0] p-7 sm:p-8 flex flex-col"
          >
            <p className="duovrai-label text-[11px] mb-2">Formule</p>
            <h3
              className="text-[22px] text-[#1A5C52] mb-1"
              style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 700 }}
            >
              Essentiel
            </h3>
            <p className="text-[14px] mb-6 text-[#555555]">
            ...
            <ul className="space-y-3 mb-8 flex-1">
              {essentialFeatures.map((item, i) => (
                <li
                  key={i}
                  className="flex items-start gap-3 text-[14px] text-[#555555]"
                >
                  <StarBullet />
                  {item}
                </li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="bg-[#1A5C52] shadow-xl rounded-[6px] p-7 sm:p-8 flex flex-col relative"
          >
            {/* Badge */}
