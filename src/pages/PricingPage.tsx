...
export function PricingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F9F3E3]">
      ...
      <main className="flex-1 py-12 sm:py-24 flex items-center justify-center">
        <div className="container mx-auto px-4 sm:px-6 w-full">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <motion.p
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="duovrai-label text-[12px] mb-4 uppercase tracking-widest text-[#B8962E] font-bold"
            >
              Étape Suivante
            </motion.p>
            <motion.h2
              ...
              className="text-[32px] sm:text-[40px] mb-4 text-[#1A5C52] leading-tight"
            ...
            >
              Pour finaliser votre commande et accéder au paiement de votre analyse personnalisée, choisissez le niveau de profondeur souhaité.
            </motion.p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <p className="duovrai-label text-[11px] mb-2 text-[#1A5C52]/70">Formule</p>
              <h3 className="text-[26px] text-[#1A5C52] mb-1" style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 700 }}>
                Essentiel
              </h3>
              <p className="text-[14px] mb-6 text-gray-500">L'analyse fondamentale de votre couple</p>
              ...
              <ul className="space-y-4 mb-10 flex-1">
                {essentialFeatures.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-[14px]" style={{ fontFamily: "'Inter', Calibri, sans-serif", color: "#444" }}>
                    <StarBullet />
                    {item}
                  </li>
                ))}
            ...
            >
              ...
              <p className="text-[11px] mb-2" style={{ fontFamily: "'Montserrat', Arial, sans-serif", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.15em", color: "#B8962E" }}>
                Formule
              </p>
              <h3
